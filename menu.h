...
public:
	void init() {
		...
		hitbox.setup(XOR("target hitbox"), XOR("hitbox"), { XOR("head"), XOR("chest"), XOR("stomach"), XOR("legs"), XOR("feet") });
		...
		prefer_accuracy.setup(XOR("strict accuracy"), XOR("prefer_accuracy"), { XOR("wait for safe lag"), XOR("wait for unlag") });
		RegisterElement(&prefer_accuracy);
		...
		optimizations.setup(XOR("optimizations"), XOR("optizations"), { XOR("limit targets per tick") });
		RegisterElement(&optimizations);

		target_limit.setup("max targets per tick", XOR("target_limit"), 3, 10, true, 0, 5.f, 1.f);
		...
		correct_opt.setup(XOR(""), XOR("correct_opt"), { XOR("correct networked angles"), XOR("correct low fake yaw"), XOR("experimental freestand correction") }, false);
		RegisterElement(&correct_opt, 1);

		fakelag_correction.setup(XOR("fakelag correction"), XOR("fakelag_correction"), { XOR("off"), XOR("safe"), XOR("predict") });
		...
		delay_shot_center.setup(XOR("delay shot for damage"), XOR("delay_shot_center"), { XOR("off"), XOR("higher damage"), XOR("highest damage") });
		RegisterElement(&delay_shot_center, 1);

		prefer_baim.setup(XOR("prefer body-aim"), XOR("prefer_baim"));
		RegisterElement(&prefer_baim, 1);

		prefer_baim_disablers.setup(XOR("prefer body aim disablers"), XOR("prefer_baim_disablers"), { XOR("body update"), XOR("moving"), XOR("networked"), XOR("low body yaw") });
...
public:
	void init() {
		...
		flags_enemy.setup(XOR("flags enemy"), XOR("flags_enemy"), { XOR("money"), XOR("reload"), XOR("armor"), XOR("flashed"), XOR("zoom"), XOR("bomb"), XOR("fake"), XOR("lethal"), XOR("tickbase"), XOR("hit")});
...
public:
	void init( ) {
		...
		bodeeeelean.setup(XOR("disable body lean"), XOR("bodeeeelean"));
		RegisterElement(&bodeeeelean, 1);

		sync.setup(XOR("sync"), XOR("sync"));
