...
public:
	...
	float m_body_timer;
	float m_body_update_time;
	float m_last_resolved_lby;
	float m_has_body_updated;
	float m_next_body_update;
	float m_last_moving_lby;
	float m_last_moving_time;
	float m_time_since_something;
	float m_first_delta;
	float m_last_update_delta;
	float m_last_update_time;
	float m_has_flicked;
	float m_last_flick_time;
	float m_last_override_time;
	float m_last_override_angle;
	float m_flick_direction;
